...
async def main() -> None:
    parser = argparse.ArgumentParser(description="Run a one-off financial analysis job")
    parser.add_argument("symbol", nargs="?", default="AAPL", help="Ticker symbol, e.g., AAPL")
